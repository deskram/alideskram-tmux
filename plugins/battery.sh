...
charging_icon=$(get_tmux_option "@alideskram-battery-charging-icon" "")
battery_missing=$(get_tmux_option "@alideskram-battery-missing-icon" "󱉝")
percentage_0=$(get_tmux_option "@alideskram-battery-percentage-0" "")
percentage_1=$(get_tmux_option "@alideskram-battery-percentage-1" "")
percentage_2=$(get_tmux_option "@alideskram-battery-percentage-2" "")
percentage_3=$(get_tmux_option "@alideskram-battery-percentage-3" "")
percentage_4=$(get_tmux_option "@alideskram-battery-percentage-4" "")
