...
display_status=$(get_tmux_option '@alideskram-git-display-status' 'false')
added_icon=$(get_tmux_option '@alideskram-git-added-icon' '')
modified_icon=$(get_tmux_option '@alideskram-git-modified-icon' '')
updated_icon=$(get_tmux_option '@alideskram-git-updated-icon' '')
deleted_icon=$(get_tmux_option '@alideskram-git-deleted-icon' '')
repo_icon=$(get_tmux_option '@alideskram-git-repo-icon' '')
diff_icon=$(get_tmux_option '@alideskram-git-diff-icon' '')
no_repo_icon=$(get_tmux_option '@alideskram-git-no-repo-icon' '')
