...
weather_scale=$(get_tmux_option "@alideskram-weather-scale" "c")
display_condition=$(get_tmux_option "@alideskram-weather-display-condition" true)
display_location=$(get_tmux_option "@alideskram-weather-display-location" false)
fixed_location=$(get_tmux_option "@alideskram-weather-location" "")
